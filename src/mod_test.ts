...
Deno.test("CoreTS module entrypoint exports the browser helpers", () => {
  ...
  assert(typeof mod.injectCoreRuntime === "function", "composite preload helper should be exported");
  assert(typeof mod.createLocalAuthDance === "function", "local auth helper should be exported");
  assert(typeof mod.generateTypeScriptSdk === "function", "OpenAPI SDK generator should be exported");
